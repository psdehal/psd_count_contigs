...
async_run_methods = {}
async_check_methods = {}
async_run_methods['psd_count_contigs.filter_contigs_async'] = ['psd_count_contigs', 'filter_contigs']
async_check_methods['psd_count_contigs.filter_contigs_check'] = ['psd_count_contigs', 'filter_contigs']
sync_methods['psd_count_contigs.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_psd_count_contigs.filter_contigs,
                             name='psd_count_contigs.filter_contigs',
                             types=[dict])
        self.method_authentication['psd_count_contigs.filter_contigs'] = 'required'
